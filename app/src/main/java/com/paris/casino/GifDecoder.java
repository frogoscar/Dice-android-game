...
public class GifDecoder {
    ...
    protected final int MAX_FRAME = 60;
    ...
    //protected Bitmap frameImage[] = new Bitmap[MAX_FRAME];
    //protected int frameDelay[] = new int[MAX_FRAME];
...
//        frameImage[frameCount] = image;
//        frameDelay[frameCount] = delay;
